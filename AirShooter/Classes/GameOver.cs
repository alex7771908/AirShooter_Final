...
namespace AirShooter.Classes
{
    public class GameOver
    {
        ...
        private Vector2 position = new Vector2(400, 230);
        ...
        public GameOver()
        {
            ...
            buttonList.Add(new Label("Exit", new Vector2(position.X, position.Y + 75), Color.White));
            lblScore = new Label("Score: 00", new Vector2(position.X, position.Y + 150), Color.White);
        }
